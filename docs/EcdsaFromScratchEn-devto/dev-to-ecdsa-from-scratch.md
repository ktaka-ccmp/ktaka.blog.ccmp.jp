...
In the [previous article](https://ktaka.blog.ccmp.jp/en/2026/WebCryptoEcdsa), we used the Web Crypto API's `crypto.subtle` to sign and verify with ECDSA. The API made it easy, but the internals remained a black box.
