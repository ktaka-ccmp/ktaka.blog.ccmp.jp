...
![FedCM account chooser](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/j5iaqnms23loexw0u4e6.png)
*FedCM account chooser (browser displays native UI)*

![Google auth page in popup window](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/hp222auucx1a0homk08s.png)
