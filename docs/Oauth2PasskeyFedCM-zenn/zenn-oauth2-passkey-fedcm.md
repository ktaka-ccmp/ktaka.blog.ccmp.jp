...
![FedCMのアカウント選択画面](https://storage.googleapis.com/zenn-user-upload/708141a6f9c0-20260314.png)
*FedCMのアカウント選択画面（ブラウザがネイティブUIを表示）*

![従来のOAuth2ポップアップ](https://storage.googleapis.com/zenn-user-upload/f5f2d88ee5e8-20260314.png)
